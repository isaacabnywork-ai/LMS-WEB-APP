      ...
      <div className="relative z-10 w-full max-w-md p-6 sm:p-10 bg-white dark:bg-slate-900 rounded-3xl shadow-2xl shadow-slate-200/20 dark:shadow-black/40 border border-slate-100 dark:border-slate-800 m-4">
        <div className="w-full">
            ...
            <div className="grid grid-cols-3 gap-2">
              {(["student", "teacher", "admin"] as const).map((r) => (
                <button
                  ...
                  type="button"
                  onClick={() => setRole(r)}
                  className={`h-16 sm:h-auto py-3 rounded-xl font-bold text-sm capitalize transition-all duration-200 border-2 ${
                    role === r
          ...
          <div className="grid grid-cols-1 gap-3">
            <button className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/50 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-sm font-semibold text-slate-700 dark:text-slate-300">
